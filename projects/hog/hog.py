...
def free_bacon(score):
    ...
    "*** YOUR CODE HERE ***"
    if score > 0:
       first = (pi % (10 ** (100 - score + 1)))
       second =(pi % (10 ** (100 - score )))
       answer = (first - second)//(10 ** (100 - score))
       return answer + 3
    else:
        return 6
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    def points0(strategy0,score0,score1,dice):
        rolls = strategy0(score0,score1)
        return take_turn(rolls,score1,dice)

    def points1(strategy1,score1,score0,dice):
        rolls = strategy1(score1,score0)
        return take_turn(rolls,score0,dice)

    while score0 < goal and score1 < goal:
        if who == 0:
            score0 += points0(strategy0,score0,score1,dice)
            new_commentary = say(score0,score1)
            say = new_commentary
            while (swine_align(score0,score1) or pig_pass(score0,score1)) and score0 < goal:
                score0 += points0(strategy0,score0,score1,dice)
                new_commentary = say(score0,score1)
                say = new_commentary
            ...
            score1 += points1(strategy1,score1,score0,dice)
            new_commentary = say(score0,score1)
            say = new_commentary
            while (swine_align(score1,score0) or pig_pass(score1,score0)) and score1 < goal:
                score1 += points1(strategy1,score1,score0,dice)
                new_commentary = say(score0,score1)
                say = new_commentary
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    avg = 0
    while dice_roll >= 1:
        roll_avg = make_averaged(roll_dice,trials_count)
        if avg < roll_avg(dice_roll,dice):
            avg = roll_avg(dice_roll,dice)
            max_rolls = dice_roll
        dice_roll -=1
    return max_rolls
